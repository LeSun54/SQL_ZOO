...
SELECT teamname, COUNT(*) AS total_number_of_goals_scored
...
SELECT matchid, mdate, COUNT(player) AS scored_by_GER
FROM goal JOIN game
ON game.id=goal.matchid
WHERE (team1 = 'GER'
OR team2 = 'GER')
...
ORDER BY mdate, matchid, team1, team2
 -- LEFT JOIN to include results from 0-0 games. Include everything from game table without needing goal table to match.
